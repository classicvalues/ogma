...
-- | A Copilot correspondence for a Lustre node can be generated by providing
-- the path to the file that declares the node.
newtype CommandOpts = CommandOpts
  { lustreFileName :: FilePath }

-- | Generate Copilot spec from Lustre node definition.
--
...
-- | Argument Lustre file to lustre conversion command
strLustreArgDesc :: String
strLustreArgDesc = "Lustre file with node definition"
